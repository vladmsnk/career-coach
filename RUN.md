...
- 📊 **Векторный поиск** - семантический поиск по вакансиям через Qdrant + Yandex Embeddings
...
- **Yandex Cloud ML** - создание эмбеддингов для семантического поиска и карьерные консультации
...
#### Yandex Cloud ML 
API ключи для Yandex GPT уже настроены в проекте и используются для:
- Карьерных консультаций 
- Создания эмбеддингов для поиска вакансий
...
├── services/               # Внешние сервисы (Yandex ML, Qdrant)
