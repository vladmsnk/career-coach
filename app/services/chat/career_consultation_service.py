...
1. Ближайшая карьерная: позиция на основе стартового контекста + обоснование почему
2. Сравнение текущих компетенций(опыта) и необходимых(в найденных вакансиях, но можешь добавить и от себя)
3. Точки роста: Конкретные области для развития (максимум 4-5 пунктов)
3. План на год-два: какие сферы надо изучать, какие проекты и активности делать
4. Рекомендуемые курсы(на яндекс практикум)
5. Небольшая мотивация и подбадривание


Ответ должен быть структурированным, практичным и не превышать 1200 символов, не используй markdown разметку. Используй дружелюбный, но профессиональный тон.
"""
